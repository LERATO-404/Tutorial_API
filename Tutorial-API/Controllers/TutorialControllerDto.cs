...
namespace Tutorial_API.Controllers{
    ...
    [Route("api/tutorials")]
    [ApiController]
    public class TutorialControllerDto : ControllerBase 
    {
        //no need
        //private readonly TutorRepoImp _tutorialRepository = new TutorRepoImp();
        private readonly ITutorial _tutorialRepository;
        private readonly IMapper _mapper;
        private readonly ILogger<TutorialControllerDto> _logger;

        //create a constructor for DJ and the register in Startup.cs ConfigureServices
        public TutorialControllerDto(ITutorial repository, IMapper mapper,ILogger<TutorialControllerDto> logger ){
